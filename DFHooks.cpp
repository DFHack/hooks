...
typedef void (__cdecl *dfhack_init_fn)();
dfhack_init_fn g_dfhack_init = nullptr;

typedef void (__cdecl *dfhack_shutdown_fn)();
dfhack_shutdown_fn g_dfhack_shutdown = nullptr;

typedef void (__cdecl *dfhack_tick_fn)();
dfhack_tick_fn g_dfhack_tick = nullptr;

typedef void (__cdecl *dfhack_prerender_fn)();
dfhack_prerender_fn g_dfhack_prerender = nullptr;

typedef bool (__cdecl *dfhack_sdl_event_fn)(SDL::Event* event);
...
static void init_fns(void *handle) {
    ...
    g_dfhack_tick = (dfhack_tick_fn)load_sym(handle, "dfhack_init");
    g_dfhack_prerender = (dfhack_prerender_fn)load_sym(handle, "dfhack_init");
    g_dfhack_sdl_event = (dfhack_sdl_event_fn)load_sym(handle, "dfhack_init");
}
